...
export const ru: Translations = {
  ...
  tours: {
    ...
    mandatoryCharges: 'Обязательные дополнительные доплаты',
    optionalCharges: 'Необязательные доплаты',
  ...
  agencyTours: {
    ...
    extraCharges: 'Дополнительные доплаты',
    mandatoryCharges: 'Обязательные дополнительные доплаты',
    mandatoryChargesHint: 'Укажите обязательные дополнительные доплаты с фиксированной ценой',
    mandatoryVariableHint: 'Укажите диапазон обязательных дополнительных доплат с неточной суммой',
    optionalCharges: 'Необязательные доплаты',
    optionalChargesHint: 'Укажите необязательные дополнительные доплаты с фиксированной ценой',
    optionalVariableHint: 'Укажите диапазон необязательных дополнительных доплат с неточной суммой',
