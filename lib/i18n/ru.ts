...
export const ru: Translations = {
  ...
  tours: {
    ...
    mandatoryCharges: 'Обязательные доплаты',
  ...
  agencyTours: {
    ...
    extraCharges: 'Дополнительные доплаты',
    mandatoryCharges: 'Обязательные доплаты',
    mandatoryChargesHint: 'Укажите обязательные доплаты с фиксированной ценой',
    mandatoryVariableHint: 'Укажите диапазон обязательных доплат с неточной суммой',
    optionalCharges: 'Необязательные доплаты',
    optionalChargesHint: 'Укажите необязательные доплаты с фиксированной ценой',
    optionalVariableHint: 'Укажите диапазон необязательных доплат с неточной суммой',
