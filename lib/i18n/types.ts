export interface Translations {
  ...
  favorites: {
    ...
    authTitle: string;
    authHint: string;
    authFeatureHint: string;
    login: string;
    register: string;
    sessionExpired: string;
    offlineHint: string;
    pendingDeletionTitle: string;
    pendingDeletionHint: string;
    contactSupport: string;
    summaryFavorites: string;
    summarySubscriptions: string;
    summaryRecentlySaved: string;
    searchSubscriptionsPlaceholder: string;
    searchFavoritesPlaceholder: string;
  ...
  notifications: {
    ...
    subtitle: string;
    sectionUser: string;
    sectionAgency: string;
    saved: string;
    save: string;
    saving: string;
    new_tour_from_followed: string;
    new_tour_from_followed_hint: string;
    price_drop: string;
    price_drop_hint: string;
    seats_low: string;
    seats_low_hint: string;
    tour_cancelled: string;
    tour_cancelled_hint: string;
    departure_reminder: string;
    departure_reminder_hint: string;
    hot_deals: string;
    hot_deals_hint: string;
    lead_confirmed: string;
    lead_confirmed_hint: string;
    lead_status_changed: string;
    lead_status_changed_hint: string;
    agency_verified_notify: string;
    agency_verified_notify_hint: string;
    weekly_picks: string;
    weekly_picks_hint: string;
    new_lead: string;
    new_lead_hint: string;
    daily_leads_summary: string;
    daily_leads_summary_hint: string;
    pending_leads_reminder: string;
    pending_leads_reminder_hint: string;
    tour_approved: string;
    tour_approved_hint: string;
    tour_rejected: string;
    tour_rejected_hint: string;
    tour_milestone: string;
    tour_milestone_hint: string;
    seats_alert: string;
    seats_alert_hint: string;
    tour_expiring: string;
    tour_expiring_hint: string;
    subscription_expiring: string;
    subscription_expiring_hint: string;
    subscription_expired: string;
    subscription_expired_hint: string;
    new_review: string;
    new_review_hint: string;
    new_follower: string;
    new_follower_hint: string;
    follower_milestone: string;
    follower_milestone_hint: string;
    verification_update: string;
    verification_update_hint: string;
  };
}
